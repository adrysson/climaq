      ...
      <center><h2 id="title">Digite o nome da cidade a qual deseja saber o clima</h2>
        <div class="card card-container">
            ...
            <?= $this->Form->create('search', ['class'=>'form-signin', 'url'=>'/climate/view']) ?>
                ...
                <?= $this->Form->input('city', ['type'=>'text', 'label'=>false, 'class'=>'form-control', 'required'=>'required', 'placeholder'=>'Digite aqui a cidade', 'value'=>$this->request->session()->read('Auth.User.user_city')])  ?>
